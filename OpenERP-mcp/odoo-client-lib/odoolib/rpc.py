...
if sys.version_info < (3, 9):
    raise RuntimeError("odoo-client-lib requires Python 3.9+ (patched build targets 3.14).")

# Python 3 only. The legacy `xmlrpclib` fallback was removed: it never runs on
# supported interpreters and `xmlrpclib` does not exist on Python 3.x.
